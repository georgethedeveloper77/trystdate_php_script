                    ...
                    <div class="combo valign-wrapper dt_othr_ur_info">
                        ...
                        <div class="dt_usr_opts_mnu">
                            <?php if( $config->connectivitySystem == "1" && !( Wo_IsFollowing($profile->id, $user->id) || Wo_IsFollowing($user->id, $profile->id) ) && !( Wo_IsFollowRequested($profile->id, (int) $user->id) || Wo_IsFollowRequested( (int) $user->id , $profile->id ) ) && (int)Wo_CountFollowing($user->id) < (int)$config->connectivitySystemLimit ){ ?>
                                <a class="tooltipped" href="javascript:void(0);" id="btn_add_friend" data-ajax-post="/profile/add_friend" data-ajax-params="to=<?php echo $profile->id;?>" data-ajax-callback="callback_add_friend" data-position="bottom" data-tooltip="<?php echo __( 'Add Friend' );?>">
                            ...
                            <?php if( $config->connectivitySystem == "1" && ( Wo_IsFollowing($profile->id, $user->id) || Wo_IsFollowing($user->id, $profile->id) ) ){ ?>
                                <a class="tooltipped" href="javascript:void(0);" id="btn_delete_friend" data-ajax-post="/profile/add_friend" data-ajax-params="to=<?php echo $profile->id;?>" data-ajax-callback="callback_add_friend" data-position="bottom" data-tooltip="<?php echo __( 'UnFriend' );?>">
                            ...
                            <?php if( $config->connectivitySystem == "1" && ( Wo_IsFollowRequested($profile->id, (int) $user->id) || Wo_IsFollowRequested( (int) $user->id , $profile->id ) ) ){ ?>
                                ...
                                <a class="tooltipped" href="javascript:void(0);" data-position="bottom" data-tooltip="<?php echo $_title_icon;?>">
                            ...
                            <a class="tooltipped" href="javascript:void(0);" id="btn_open_private_conversation" data-ajax-post="/chat/open_private_conversation" data-ajax-params="from=<?php echo $profile->id;?>&web_device_id=<?php echo $profile->web_device_id;?>" data-ajax-callback="open_private_conversation" data-position="bottom" data-tooltip="<?php echo __( 'Message' );?>">
                            ...
                            <?php //if(isGenderFree($user->gender) === true ){?>
                                <a class="tooltipped" href="javascript:void(0);" data-ajax-post="/profile/open_gift_model" data-ajax-params="" data-ajax-callback="callback_open_gift_model" data-position="bottom" data-tooltip="<?php echo __( 'Send a gift' );?>">
                            ...
                            <?php if( isset( $_COOKIE[ 'JWT' ] ) && !empty( $_COOKIE[ 'JWT' ] ) && $profile->admin !== '1' ){ ?>
                                ...
                                <?php if( !isUserReported( $profile->id ) ) { ?>
                                    <a class="report_text modal-trigger tooltipped" href="#modal_report" data-position="bottom" data-tooltip="<?php echo __( 'Report User' );?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z" /></svg>
                                    </a>
                                <?php }else{ ?>
                                    <a href="javascript:void(0);" data-ajax-post="/useractions/unreport" data-ajax-params="userid=<?php echo $profile->id;?>&web_device_id=<?php echo $profile->web_device_id;?>" data-ajax-callback="callback_unreport" class="report_text tooltipped" data-position="bottom" data-tooltip="<?php echo __( 'Remove report' );?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M13,9H18.5L13,3.5V9M10,14.59L7.88,12.46L6.46,13.88L8.59,16L6.46,18.12L7.88,19.54L10,17.41L12.12,19.54L13.54,18.12L11.41,16L13.54,13.88L12.12,12.46L10,14.59Z" /></svg>
                                    </a>
                                <?php } ?>
                            <?php } ?>
                            <?php if( isset( $_COOKIE[ 'JWT' ] ) && !empty( $_COOKIE[ 'JWT' ] ) && auth()->admin == '1' ){ ?>
                                <a href="<?php echo $site_url;?>/settings/<?php echo $profile->username;?>" data-ajax="/settings/<?php echo $profile->username;?>" class="dt_edt_prof_link tooltipped" data-position="bottom" data-tooltip="<?php echo __( 'Edit' );?>">
