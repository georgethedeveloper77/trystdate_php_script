    <?php if(IS_LOGGED == true){ ?>
		...
		<div id="pay_modal_wallet">
            <div class="modal modal-sm" id="pay-go-pro" role="dialog" data-keyboard="false">
				<div class="modal-content">
					<h4 class="bold"><?php echo __( 'pay_from_credits' );?></h4>
		...
		<div class="payment_v_modalx modal modal-sm">
			<div class="modal-content">
				<h4><?php echo __( 'unlock_private_video_payment' );?></h4>
				<div class="modal-body">
		...
		<?php if ($config->aamarpay_payment == '1') { ?>
			<div class="modal fade" id="aamarpay_modal" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<h4><?php echo __( 'aamarpay' );?></h4>
						<div class="modal-body">
							<div id="aamarpay_alert" style="    color: red;"></div>
							<form id="aamarpay_form" method="post">
								<div class="to_mat_input">
									<input class="browser-default" type="text" placeholder="<?php echo __( 'Name' );?>"  value="<?php echo $profile->full_name;?>" id="aamarpay_name">
									<label for="aamarpay_name"><?php echo __( 'Name' );?></label>
								</div>
								<div class="to_mat_input">
									<input class="browser-default" type="email" placeholder="<?php echo __( 'Email' );?>" value="" data-email="<?php echo base64_encode($profile->email);?>" id="aamarpay_email">
									<label for="aamarpay_email"><?php echo __( 'Email' );?></label>
								</div>
								<div class="to_mat_input">
									<input id="aamarpay_number" class="browser-default" type="text" placeholder="<?php echo __( 'phone' );?>">
									<label for="aamarpay_number"><?php echo __( 'phone' );?></label>
								</div>
								<div class="modal-footer">
									<button type="button" class="modal-close waves-effect btn-flat"><?php echo __( 'Cancel' );?></button>
									<button type="button" class="waves-effect waves-light btn-flat btn_primary white-text" onclick="AamarpayRequest()" id="aamarpay_button"><?php echo __( 'Pay' );?></button>
								</div>
							</form>
						</div>
					</div>
		...
		<?php if(IS_LOGGED === true){ ?>
            ...
            <?php if ($config->checkout_payment == 'yes') { ?>
                <div class="modal" id="2checkout_modal" role="dialog" data-keyboard="false">
					<div class="modal-content">
						...
						<form class="form form-horizontal" method="post" id="2checkout_form" action="#">
							<div class="modal-body twocheckout_modal">
								...
								<div class="row">
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_name" class="browser-default" type="text" placeholder="<?php echo __( 'name' );?>" value="<?php echo $profile->full_name;?>">
											<label for="card_name"><?php echo __( 'name' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_address" class="browser-default" type="text" placeholder="<?php echo __( 'address' );?>" value="<?php echo $profile->address;?>">
											<label for="card_address"><?php echo __( 'address' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_city" class="browser-default" type="text" placeholder="<?php echo __( 'city' );?>" value="<?php echo $profile->city;?>">
											<label for="card_city"><?php echo __( 'city' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_state" class="browser-default" type="text" placeholder="<?php echo __( 'state' );?>" value="<?php echo $profile->state;?>">
											<label for="card_state"><?php echo __( 'state' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_zip" class="browser-default" type="text" placeholder="<?php echo __( 'zip' );?>" value="<?php echo $profile->zip;?>">
											<label for="card_zip"><?php echo __( 'zip' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<select id="card_country" name="card_country" class="browser-default pp_select_has_label">
									...
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_email" class="browser-default" type="email" placeholder="<?php echo __( 'email' );?>" value="<?php echo $profile->email;?>">
											<label for="card_email"><?php echo __( 'email' );?></label>
										</div>
									</div>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="card_phone" class="browser-default" type="tel" placeholder="<?php echo __( 'phone number' );?>" value="<?php echo $profile->cc_phone_number;?>">
								...
								<div class="row two_check_card">
									<div class="col s12">
										<div class="to_mat_input">
											<input id="_number_" class="browser-default" type="text" placeholder="<?php echo __( 'card number' );?>">
									...
									<div class="col s4">
										<div class="to_mat_input">
											<select id="card_month" name="card_month" class="browser-default pp_select_has_label">
									...
									<div class="col s4 no-padding-both">
										<div class="to_mat_input">
											<select id="card_year" name="card_year" class="browser-default pp_select_has_label">
									...
									<div class="col s4">
										<div class="to_mat_input">
											<input id="card_cvc" name="card_cvc" class="browser-default" type="text" placeholder="CVC" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn_primary" onclick="tokenRequest()" id="2checkout_btn"><?php echo __('pay');?></button>
							</div>
						</form>
					</div>
                </div>
    ...
    <?php if ($config->cashfree_payment == 'yes') { ?>
        <div class="modal" id="cashfree_modal_box" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-content add_money_modal add_address_modal">
                ...
                <div class="modal-body">
                    ...
                    <form id="cashfree_form" method="post">
						<div class="to_mat_input">
							<input id="cashfree_name" name="name" class="browser-default" type="text" placeholder="<?php echo __( 'name' );?>" value="<?php echo $profile->full_name; ?>">
							<label for="cashfree_name"><?php echo __( 'name' );?></label>
						</div>
						<div class="to_mat_input">
							<input id="cashfree_email" name="email" class="browser-default" type="email" placeholder="<?php echo __( 'email' );?>" value="<?php echo $profile->email; ?>">
							<label for="cashfree_email"><?php echo __( 'email' );?></label>
						</div>
						<div class="to_mat_input">
							<input id="cashfree_phone" name="phone" class="browser-default" type="tel" placeholder="<?php echo __( 'phone_number' );?>" value="<?php echo $profile->phone_number; ?>">
							<label for="cashfree_phone"><?php echo __( 'phone_number' );?></label>
						</div>
						...
						<div class="modal-footer">
							<button class="modal-close waves-effect btn-flat"><?php echo __( 'Cancel' );?></button>
							<button type="button" class="btn btn_primary" onclick="InitializeCashfree()" id="cashfree_button"><?php echo __('pay');?></button>
						</div>
                    </form>
                </div>
			</div>
