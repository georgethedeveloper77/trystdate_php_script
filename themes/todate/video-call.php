<style>footer.page_footer {display: none}</style>

<div class="video-con">
	<?php if ($config->agora_chat_call == 1) { ?>
		<div id="full-screen-video"></div>
		<div id="local-video" class="agora_vdeo_call"></div>
